...
public class LoginWorkStepDef {
    ...
    public void user_provides_username_and_password_to_the_login_page() throws InterruptedException {
    ...
    public void user_provides_and_to_the_login_page(String username, String password) throws InterruptedException {
