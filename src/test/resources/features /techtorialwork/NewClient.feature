...
Feature: Testing New Client Create,Search and Order Functionality
  ...
  Scenario: Happy Path create functionality for new client
    ...
    And User clicks add client and provides 'John Doe', 'john.d6110@example.com','United States','3147353233' for ClientPage
    ...
    Then User clicks save button and validates 'John Doe','Doe Construction Inc.','john.d6110@example.com','Active' from table.
  ...
  Scenario Outline: Happy Path create functionality for new client with Scenario Outline
    ...
    Examples:
      ...
      | John Doe     | john.do811618@example.com  | United States | 3147353233 | Doe Construction Inc. | https://www.doeconstruction.com | 31442423322  | 456 Oak Avenue, Springfield, IL, 62701 | 789 Birch Lane, Springfield, IL, 62702 | Active |
      | Ahmet Baldir | ahmet.do811619@example.com | Turkey        | 2342342342 | Ahmet Baldir company  | https://www.ahmetbaldir.com     | 33453453434  | 567 Oak Avenue, Springfield, IL, 62701 | 123 Birch Lane, Springfield, IL, 62702 | Active |
