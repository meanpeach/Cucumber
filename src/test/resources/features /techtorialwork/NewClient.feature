...
Feature: Testing New Client Create,Search and Order Functionality
  ...
  Scenario: Happy Path create functionality for new client
    ...
    And User clicks add client and provides 'John Doe', 'j.1di5555@example.com','United States','3147353233' for ClientPage
    ...
    Then User clicks save button and validates 'John Doe','Doe Construction Inc.','j.1di5555@example.com','Active' from table.
...
#      | John Doe     | john.d55@example.com  | United States | 3147353233 | Doe Construction Inc. | https://www.doeconstruction.com | 31442423322  | 456 Oak Avenue, Springfield, IL, 62701 | 789 Birch Lane, Springfield, IL, 62702 | Active |
#      | Ahmet Baldir | ahmet.d55@example.com | Turkey        | 2342342342 | Ahmet Baldir company  | https://www.ahmetbaldir.com     | 33453453434  | 567 Oak Avenue, Springfield, IL, 62701 | 123 Birch Lane, Springfield, IL, 62702 | Active |
